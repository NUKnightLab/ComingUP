 ...
 * @usage
 * ```html
 * <script id="my-LikedEvents.html" type="text/ng-template">
 *   <ion-modal-view>
 *     <ion-header-bar>
 ...
 *   $ionicModal.fromTemplateUrl('my-LikedEvents.html', {
 *     scope: $scope,
 ...
 *           'home-tab': {
 *             prefetchTemplate: false,
 *             templateUrl: "tabs-templates/featured.html",
 ...
 * and then try to load featured.html into the `<ion-nav-view>`.
 *
 * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
 * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
 * So here is one way to put featured.html into our app:
 *
 * ```html
